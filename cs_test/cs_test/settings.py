"""
Django settings for cs_test project.
...
SECRET_KEY = "django-insecure-f(j28*jpoc_+k4qesjpxorylt!gy3^u&hxsyrna0vy$r!_@$pf"
...
WSGI_APPLICATION = "cs_test.wsgi.application"
